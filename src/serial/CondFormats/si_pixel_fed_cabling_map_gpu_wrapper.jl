...
# Constructor
- si_pixel_fed_cabling_map_gpu_wrapper(cabling_map::SiPixelFedCablingMapGPU, mod_to_unp::Vector{UInt8}): Initializes a new wrapper instance with the provided cabling map and module-to-unpacker mapping.
...
mutable struct SiPixelFedCablingMapGPUWrapper
    ...
    function si_pixel_fed_cabling_map_gpu_wrapper(cabling_map::SiPixelFedCablingMapGPU, mod_to_unp::Vector{UInt8})

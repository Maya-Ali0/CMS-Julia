...
function loadCovariance2D(ge::M6xNf, hits_cov::M2Nd) where {M6xNf,M2Nd}
    ...
    for i in 1:hits_in_fit
        ...
        j = 2
        l = 2
        element2 = column_i[ge_idx]
        hits_cov[i + j * hits_in_fit, i + j * hits_in_fit] = element2

        ge_idx = 2
        j = 2
        l = 1
        element3 = column_i[ge_idx]
        hits_cov[i + l * hits_in_fit, i + j * hits_in_fit] = hits_cov[i + j * hits_in_fit, i + l * hits_in_fit] = element3
